...
public class TestController {
    ...
    public Map<String, Object> getTestAll(@RequestBody(required = false) SearchEntity<TestEntity> searchEntity) {
        log.debug("-------------------getTestAll:获取全部Test-------------");
        return testService.getTestAllService(searchEntity);
    }
